...
// List all towns which have summer average temperatures greater than 25 degrees and have
// resort/s which are owned by a company named "Tropical Dream".
...
db.town.updateMany({'resorts.company_name': "Tropical Dream"},
...
db.town.updateOne({"name":"Mount Isa, QLD", "location.latitude":-20.7256, "location.longitude":139.4927 },
{"$push":{"resorts":
        
    {
    "resorts.id" : 10,
    "resorts.name" : "Amazing Resort",
    "resorts.address" : "1 the place to be avenue",
    "resorts.phone" : 0444544445,
    "resorts.year_built" : 2023,
    "resorts.company_name" : 'Australia Experience'
    }
...
db.town.find({"name":"Mount Isa, QLD", "location.latitude":-20.7256, "location.longitude":139.4927 });
